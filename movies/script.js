...
let arrayMainosImg = ["../img/mainos2.jpg", "../img/mainos1.jpg", "../img/mainos3.jpg", "../img/mainos4.jpg", "../img/mainos5.jpg", "../img/mainos6.jpg"];
let index=0;
function VaindaMainosImg() {
    document.getElementById("mainosImg").setAttribute("src", arrayMainosImg[index]);
    index++;
    if (index==arrayMainosImg.length) {index=0};
